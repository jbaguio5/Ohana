            ...
            <div class="boxdeco">
                ...
                <div class="admin">
                    <fieldset style="font-size: larger">
                        <label><a href="/AddProductAdmin">Add Product</a></label>
                        <label><a href="/RemoveProductList">Remove Product</a></label>
                        <label><a href="/EditProductList">Edit Product</a></label>
                        <label><a href="/RemoveUserList">Remove User</a></label>
                    </fieldset>
                </div>
            </div>
</div>
