...
@WebServlet(name = "JoysticksListServlet", urlPatterns = {"/Joysticks"})
public class JoysticksListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //query for list of products of type joystick
            Query q = em.createQuery("SELECT p FROM Products p WHERE p.productType = :arg1");
            //set joystick to string
            String arg1 = "joystick";
            //set string arg1 to parameter arg1 for query
